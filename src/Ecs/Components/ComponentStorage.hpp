...
template <typename T> class ComponentStorage final : public BaseComponentStorage {
    ...
    std::vector<int> _dense;  // Для плотного хранения реально существующих элементов (сущностей, на
                              // которых есть компоненты)
