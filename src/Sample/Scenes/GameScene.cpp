...
void GameScene::Init() {
    ...
    systemsManager.AddSystem(std::make_shared<RenderSystem>(world, gameEngine.Window(), _renderMode, levelConfig.Height));
    ...
    for (const auto& object : levelConfig.Objects) {
        if (object.Name == PlayerObject) {
            ...
            auto& playerPosition = positions.Add(player, PositionComponent(object.X + config.Player.BboxWidth / 2.0f, object.Y - config.Player.BboxHeight / 2.0f));
        ...
        if (object.Name == GoombaObject) {
            ...
            auto& goombaPosition = positions.Add(goomba, PositionComponent(object.X + config.Goomba.BboxWidth / 2.0f, object.Y - config.Goomba.BboxHeight / 2.0f));
            goombaPosition.Scale = {config.Goomba.BboxWidth / baseAnimation.Size().x, config.Goomba.BboxHeight / baseAnimation.Size().y};
            ...
            goombaAnimator.Animations.emplace(GoombaMoveState, gameEngine.Assets().GetAnimation(config.Goomba.Animations.at(0)));

            if (object.PatrolPoints.size() >= 2) {
                patrols.Add(goomba,
                    PatrolComponent({object.PatrolPoints.at(0).X + config.Goomba.BboxWidth / 2.0f, object.PatrolPoints.at(0).Y - config.Goomba.BboxHeight / 2.0f},
                        {object.PatrolPoints.at(1).X + config.Goomba.BboxWidth / 2.0f, object.PatrolPoints.at(1).Y - config.Goomba.BboxHeight / 2.0f}));
            } else {
                patrols.Add(goomba, PatrolComponent(goombaPosition.Position, goombaPosition.Position));
            }

            boxColliders.Add(goomba, BoxColliderComponent(config.Goomba.BboxWidth, config.Goomba.BboxHeight));
        ...
        if (object.Name == TileObject) {
            ...
            positions.Add(tile, PositionComponent(object.X + LevelConfig::CellSize / 2.0f, object.Y - LevelConfig::CellSize / 2.0f));
        ...
        if (object.Name == BrickObject) {
            ...
            positions.Add(brick, PositionComponent(object.X + LevelConfig::CellSize / 2.0f, object.Y - LevelConfig::CellSize / 2.0f));
        ...
        if (object.Name == QuestionObject) {
            ...
            positions.Add(questionTile, PositionComponent(object.X + LevelConfig::CellSize / 2.0f, object.Y - LevelConfig::CellSize / 2.0f));
            sprites.Add(questionTile, SpriteComponent(gameEngine.Assets().GetTexture(config.QuestionTile.BaseTexture)));
            boxColliders.Add(questionTile, BoxColliderComponent(LevelConfig::CellSize, LevelConfig::CellSize));
        ...
        if (object.Name == FinishObject) {
            ...
            positions.Add(finish, PositionComponent(object.X + LevelConfig::CellSize / 2.0f, object.Y - LevelConfig::CellSize));
        ...
        if (decoration != nullptr) {
            ...
            positions.Add(decor, PositionComponent(object.X + textureSize.x / 2.0f, object.Y - textureSize.y / 2.0f));
