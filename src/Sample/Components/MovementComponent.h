...
struct MovementComponent {
    ...
    MovementComponent(const float speed, const sf::Vector2f& direction)
        : Speed(speed), Direction(direction) {}
    MovementComponent(const float speed, const float x, const float y)
        : Speed(speed), Direction(x, y) {}
    ...
    MovementComponent(const float speed,
